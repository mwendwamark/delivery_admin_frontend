...
//         Please choose your role to sign in or sign up.
//       </p>
//     </div>
...
//         ) : (
//           <>
//             Sign In <HiOutlineArrowLongRight />
//           </>
//         )}
//       </button>
//     </form>
...
//         ) : (
//           <>
//             Create Admin Account <HiOutlineArrowLongRight />
//           </>
//         )}
//       </button>
//     </form>
...
//         ) : (
//           <>
//             Create Delivery Account <HiOutlineArrowLongRight />
//           </>
//         )}
//       </button>
//     </form>
...
//           showMessage(
//             "error",
//             "Access Denied: Incorrect role for this portal."
//           );
...
//           // Admin role
//           navigate("/admin/products"); // Example: root of admin dashboard
...
//       if (
//         currentSignupData.password !== currentSignupData.password_confirmation
//       ) {
...
//   const switchToAdminSignup = useCallback(
//     () => setCurrentView("adminSignup"),
//     []
//   );
...
//     []
//   );
//   const switchToDeliverySignup = useCallback(
//     () => setCurrentView("deliverySignup"),
//     []
//   );
//   const switchToDeliveryLogin = useCallback(
//     () => setCurrentView("deliveryLogin"),
//     []
//   );
...
//             setSignupData={setAdminSignupData}
//             showPassword={showPassword}
...
//         return (
//           <DeliverySignupForm
//             signupData={deliverySignupData}
//             setSignupData={setDeliverySignupData}
//             showPassword={showPassword}
//             showConfirmPassword={showConfirmPassword}
//             setShowPassword={setShowPassword}
//             setShowConfirmPassword={setShowConfirmPassword}
...
//       image = heroDelivery;
//       title =
//         currentView === "deliveryLogin" ? "Delivery Login" : "Delivery Signup";
//       text =
//         currentView === "deliveryLogin"
...
//                 className="auth-link back-to-roles"
//               >
...
const StaffAuthPages = () => {
  ...
  const handleLogin = useCallback(
    ...
    [loginData, showMessage, navigate]
  );
